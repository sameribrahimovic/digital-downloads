...
export default function Product({ product }) {
  ...
  //If the product does not exist we handle this case by returning an empty page
  if (!product) {
    return null;
  }

  //check if user is logged in and has set the name
  ...
  //if everything is ok with user and session show content
  return (
    <div>
      <Head>
...
export async function getServerSideProps(context) {
  ...
  //check if the current user is owner/creator of product
